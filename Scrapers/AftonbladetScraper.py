...
def scrape_aftonbladet(max_articles=20):
    ...
    for tag in headline_tags:
        ...
        if link and not link.startswith("/minekonomi/"):
            link = "https://www.aftonbladet.se/minekonomi/" + link
...
if __name__ == "__main__":
    scrape_aftonbladet(max_articles=20)
